...
DATABASE_NAME = 'ethiomedical_bussiness'  # Replace with your database name
...
def create_table_if_not_exists(conn):
    try:
        ...
        column_definitions = [
            ...
            "[Channel_Username] NVARCHAR(MAX)",
            "[ID] NVARCHAR(MAX)",
            "[Message] NVARCHAR(MAX)",
            "[Date] NVARCHAR(MAX)",
            "[Media_Path] NVARCHAR(MAX)"
        ]
        ...
        CREATE TABLE {TABLE_NAME} ({column_definitions_str});
        """
